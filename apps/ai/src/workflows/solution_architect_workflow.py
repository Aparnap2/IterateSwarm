"""OntologyAI V5.2 — SolutionArchitectWorkflow (PRD §8.5 / §16.5).
...
class SolutionArchitectWorkflow:
    """Solution Architect specialist workflow (PRD §8.5 / §16.5)."""
    ...
    def run(
        ...
        Returns:
            SpecialistResponse with specialist="SolutionArchitect" and patches to
        ...
        for idx, finding in enumerate(action_worthy):
            ...
            if propose_execution:
                action = ActionRegistry.create(
                    ...
                    target_id=draft.id,
                    requested_by="SolutionArchitect",
        ...
        return SpecialistResponse(
            ...
            workflow_name="SolutionArchitectWorkflow",
            summary=summary,
