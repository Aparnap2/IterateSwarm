...
class TestHiringRemoved:
    """Hiring must not appear in active surfaces (9-runtime model)."""
    ...
    def test_hiring_not_in_authority_manifest(self):
        """Hiring must not appear in authority_manifest.py (agents are implementation detail inside 9 runtimes)."""
